...
`timescale 1 ps / 1 ps
module ZFsoc_mm_interconnect_1 (
		input  wire        clk_0_clk_clk,                                  //                                clk_0_clk.clk
		input  wire        nios2_gen2_0_reset_reset_bridge_in_reset_reset, // nios2_gen2_0_reset_reset_bridge_in_reset.reset
		input  wire        switch_reset_reset_bridge_in_reset_reset,       //       switch_reset_reset_bridge_in_reset.reset
	...
	wire  [88:0] rsp_mux_src_data;                                                                   // rsp_mux:src_data -> nios2_gen2_0_data_master_agent:rp_data
	...
	wire  [88:0] rsp_mux_001_src_data;                                                               // rsp_mux_001:src_data -> nios2_gen2_0_instruction_master_agent:rp_data
	...
	wire  [89:0] sysid_qsys_0_control_slave_agent_rf_source_data;                                    // sysid_qsys_0_control_slave_agent:rf_source_data -> sysid_qsys_0_control_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] sysid_qsys_0_control_slave_agent_rsp_fifo_out_data;                                 // sysid_qsys_0_control_slave_agent_rsp_fifo:out_data -> sysid_qsys_0_control_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [89:0] nios2_gen2_0_debug_mem_slave_agent_rf_source_data;                                  // nios2_gen2_0_debug_mem_slave_agent:rf_source_data -> nios2_gen2_0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] nios2_gen2_0_debug_mem_slave_agent_rsp_fifo_out_data;                               // nios2_gen2_0_debug_mem_slave_agent_rsp_fifo:out_data -> nios2_gen2_0_debug_mem_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [12:0] sdram_pll_pll_slave_agent_m0_address;                                               // sdram_pll_pll_slave_agent:m0_address -> sdram_pll_pll_slave_translator:uav_address
	...
	wire  [89:0] sdram_pll_pll_slave_agent_rf_source_data;                                           // sdram_pll_pll_slave_agent:rf_source_data -> sdram_pll_pll_slave_agent_rsp_fifo:in_data
	...
	wire  [89:0] sdram_pll_pll_slave_agent_rsp_fifo_out_data;                                        // sdram_pll_pll_slave_agent_rsp_fifo:out_data -> sdram_pll_pll_slave_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [89:0] onchip_memory2_0_s1_agent_rf_source_data;                                           // onchip_memory2_0_s1_agent:rf_source_data -> onchip_memory2_0_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] onchip_memory2_0_s1_agent_rsp_fifo_out_data;                                        // onchip_memory2_0_s1_agent_rsp_fifo:out_data -> onchip_memory2_0_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [12:0] led_s1_agent_m0_address;                                                            // led_s1_agent:m0_address -> led_s1_translator:uav_address
	...
	wire  [88:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_s1_agent:cp_data
	...
	wire  [12:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [89:0] switch_s1_agent_rf_source_data;                                                     // switch_s1_agent:rf_source_data -> switch_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] switch_s1_agent_rsp_fifo_out_data;                                                  // switch_s1_agent_rsp_fifo:out_data -> switch_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [12:0] button_s1_agent_m0_address;                                                         // button_s1_agent:m0_address -> button_s1_translator:uav_address
	...
	wire  [89:0] button_s1_agent_rf_source_data;                                                     // button_s1_agent:rf_source_data -> button_s1_agent_rsp_fifo:in_data
	...
	wire  [89:0] button_s1_agent_rsp_fifo_out_data;                                                  // button_s1_agent_rsp_fifo:out_data -> button_s1_agent:rf_sink_data
	...
	wire  [88:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> button_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> button_s1_agent:cp_channel
	...
	wire  [88:0] nios2_gen2_0_data_master_agent_cp_data;                                             // nios2_gen2_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [88:0] nios2_gen2_0_instruction_master_agent_cp_data;                                      // nios2_gen2_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire  [88:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_002:sink_data
	...
	wire  [88:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire  [88:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [88:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [88:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [88:0] router_006_src_data;                                                                // router_006:src_data -> rsp_demux_004:sink_data
	...
	wire  [88:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [88:0] router_007_src_data;                                                                // router_007:src_data -> rsp_demux_005:sink_data
	...
	wire  [88:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [88:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_004:sink1_data
	...
	wire  [88:0] cmd_demux_001_src5_data;                                                            // cmd_demux_001:src5_data -> cmd_mux_005:sink1_data
	...
	wire  [88:0] cmd_demux_001_src6_data;                                                            // cmd_demux_001:src6_data -> cmd_mux_006:sink1_data
	...
	wire  [88:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> rsp_mux_001:sink4_data
	...
	wire  [88:0] rsp_demux_005_src1_data;                                                            // rsp_demux_005:src1_data -> rsp_mux_001:sink5_data
	...
	wire  [88:0] rsp_demux_006_src1_data;                                                            // rsp_demux_006:src1_data -> rsp_mux_001:sink6_data
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                            //                      clk.clk
		.reset                  (switch_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                              //             clk.clk
		.reset                   (switch_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_router router (
	...
	ZFsoc_mm_interconnect_1_router router_001 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_002 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_003 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_004 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_005 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_006 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_007 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_008 (
	...
	ZFsoc_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	ZFsoc_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                            // in_clk_0.clk
		.in_rst_0_reset (switch_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
