...
module ZFsoc_mm_interconnect_1 (
	...
	wire  [14:0] i2c_0_csr_agent_m0_address;                                                         // i2c_0_csr_agent:m0_address -> i2c_0_csr_translator:uav_address
	...
	wire  [92:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> i2c_0_csr_agent:cp_data
	...
	wire  [14:0] sdram_pll_pll_slave_agent_m0_address;                                               // sdram_pll_pll_slave_agent:m0_address -> sdram_pll_pll_slave_translator:uav_address
	...
	wire  [92:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> sdram_pll_pll_slave_agent:cp_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> led_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // led_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> led_s1_agent:cp_channel
	...
	wire  [14:0] switch_s1_agent_m0_address;                                                         // switch_s1_agent:m0_address -> switch_s1_translator:uav_address
	...
	wire  [92:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> switch_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // switch_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [14:0] button_s1_agent_m0_address;                                                         // button_s1_agent:m0_address -> button_s1_translator:uav_address
	...
	wire  [92:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> button_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // button_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> button_s1_agent:cp_channel
	...
	wire  [92:0] i2c_0_csr_agent_rp_data;                                                            // i2c_0_csr_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] sdram_pll_pll_slave_agent_rp_data;                                                  // sdram_pll_pll_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] led_s1_agent_rp_data;                                                               // led_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [92:0] switch_s1_agent_rp_data;                                                            // switch_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [92:0] button_s1_agent_rp_data;                                                            // button_s1_agent:rp_data -> router_010:sink_data
	...
	ZFsoc_mm_interconnect_1_router_002 router_009 (
	...
	ZFsoc_mm_interconnect_1_router_002 router_010 (
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_007 (
		.clk                 (clk_0_clk_clk),                            //       clk.clk
		.reset               (switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_cmd_mux cmd_mux_008 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_007 (
		.clk                (clk_0_clk_clk),                            //       clk.clk
		.reset              (switch_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_1_rsp_demux rsp_demux_008 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
