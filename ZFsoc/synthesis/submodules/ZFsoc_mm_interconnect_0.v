...
`timescale 1 ps / 1 ps
module ZFsoc_mm_interconnect_0 (
	...
	wire  [76:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> sdram_s1_agent:cp_data
	...
	wire  [76:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_001:sink_data
	...
	ZFsoc_mm_interconnect_0_router router (
	...
	ZFsoc_mm_interconnect_0_router_001 router_001 (
	...
	ZFsoc_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                              //       clk.clk
		.reset              (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_0_cmd_demux rsp_demux (
		.clk                (sdram_pll_c0_clk),                        //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                              //       clk.clk
		.reset               (bridge_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	ZFsoc_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
