...
//altsyncram ADDRESS_REG_B="CLOCK0" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_INPUT_B="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_B="BYPASS" DEVICE_FAMILY="MAX 10" INDATA_REG_B="CLOCK0" NUMWORDS_A=32768 NUMWORDS_B=32768 OPERATION_MODE="BIDIR_DUAL_PORT" OUTDATA_ACLR_A="NONE" OUTDATA_ACLR_B="NONE" OUTDATA_REG_A="UNREGISTERED" OUTDATA_REG_B="UNREGISTERED" POWER_UP_UNINITIALIZED="FALSE" READ_DURING_WRITE_MODE_MIXED_PORTS="DONT_CARE" read_during_write_mode_port_a="NEW_DATA_WITH_NBE_READ" read_during_write_mode_port_b="NEW_DATA_WITH_NBE_READ" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_BYTEENA_B=1 WIDTHAD_A=15 WIDTHAD_B=15 WRCONTROL_WRADDRESS_REG_B="CLOCK0" address_a address_b clock0 data_a data_b q_a q_b rden_a rden_b wren_a wren_b
...
`endif
	...
	wire  [2:0]  w_anode448w;
	wire  [2:0]  w_anode456w;
	wire  [2:0]  w_anode464w;
	...
	assign
		...
		eq = eq_node,
		eq_node = eq_wire[3:0],
		eq_wire = {w_anode464w[2], w_anode456w[2], w_anode448w[2], w_anode435w[2]},
		w_anode435w = {(w_anode435w[1] & (~ data_wire[1])), (w_anode435w[0] & (~ data_wire[0])), enable_wire},
		w_anode448w = {(w_anode448w[1] & (~ data_wire[1])), (w_anode448w[0] & data_wire[0]), enable_wire},
		w_anode456w = {(w_anode456w[1] & data_wire[1]), (w_anode456w[0] & (~ data_wire[0])), enable_wire},
		w_anode464w = {(w_anode464w[1] & data_wire[1]), (w_anode464w[0] & data_wire[0]), enable_wire};
endmodule //sram_15bit_decode
...
`endif
	...
	assign
		result = result_node,
		result_node = {(((w_data656w[1] & sel_node[0]) & (~ (((w_data656w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data656w[2]))))) | ((((w_data656w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data656w[2]))) & (w_data656w[3] | (~ sel_node[0])))), (((w_data631w[1] & sel_node[0]) & (~ (((w_data631w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data631w[2]))))) | ((((w_data631w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data631w[2]))) & (w_data631w[3] | (~ sel_node[0])))), (((w_data606w[1] & sel_node[0]) & (~ (((w_data606w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data606w[2]))))) | ((((w_data606w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data606w[2]))) & (w_data606w[3] | (~ sel_node[0])))), (((w_data581w[1] & sel_node[0]) & (~ (((w_data581w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data581w[2]))))) | ((((w_data581w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data581w[2]))) & (w_data581w[3] | (~ sel_node[0])))), (((w_data556w[1] & sel_node[0]) & (~ (((w_data556w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data556w[2]))))) | ((((w_data556w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data556w[2]))) & (w_data556w[3] | (~ sel_node[0])))), (((w_data531w[1] & sel_node[0]) & (~ (((w_data531w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data531w[2]))))) | ((((w_data531w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data531w[2]))) & (w_data531w[3] | (~ sel_node[0])))), (((w_data506w[1] & sel_node[0]) & (~ (((w_data506w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data506w[2]))))) | ((((w_data506w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data506w[2]))) & (w_data506w[3] | (~ sel_node[0])))), (((w_data476w[1]
 & sel_node[0]) & (~ (((w_data476w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data476w[2]))))) | ((((w_data476w[0] & (~ sel_node[1])) & (~ sel_node[0])) | (sel_node[1] & (sel_node[0] | w_data476w[2]))) & (w_data476w[3] | (~ sel_node[0]))))},
		sel_node = {sel[1:0]},
		w_data476w = {data[24], data[16], data[8], data[0]},
		w_data506w = {data[25], data[17], data[9], data[1]},
		w_data531w = {data[26], data[18], data[10], data[2]},
		w_data556w = {data[27], data[19], data[11], data[3]},
		w_data581w = {data[28], data[20], data[12], data[4]},
		w_data606w = {data[29], data[21], data[13], data[5]},
		w_data631w = {data[30], data[22], data[14], data[6]},
		w_data656w = {data[31], data[23], data[15], data[7]};
endmodule //sram_15bit_mux

//synthesis_resources = lut 48 M9K 32 reg 8 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"OPTIMIZE_POWER_DURING_SYNTHESIS=NORMAL_COMPILATION"} *)
module  sram_15bit_altsyncram
	( 
	address_a,
	address_b,
	clock0,
...
`endif
	...
	wire  [1:0]  w_addr_val_a13w;
	wire  [1:0]  w_addr_val_b14w;
	...
	always @ ( posedge clock0)
		  wren_b_store <= wren_b;
	sram_15bit_decode   decode2
	( 
	.data(address_a_wire[14:13]),
	.enable(wren_a),
	.eq(wire_decode2_eq));
	sram_15bit_decode   decode3
	( 
	.data(w_addr_val_b4w),
	.enable(wren_b),
	.eq(wire_decode3_eq));
	sram_15bit_decode   rden_decode_a
	( 
	.data(w_addr_val_a13w),
	.enable(((wren_a_store | wren_a) | (rden_a_store | rden_a))),
	.eq(wire_rden_decode_a_eq));
	sram_15bit_decode   rden_decode_b
	( 
	.data(w_addr_val_b14w),
	.enable(((wren_b_store | wren_b) | (rden_b_store | rden_b))),
	...
	assign
		...
		w_addr_val_a13w = wren_decode_addr_sel_a,
		w_addr_val_b14w = wren_decode_addr_sel_b,
...
endmodule //sram_15bit_altsyncram
//VALID FILE
...
`endif
	...
	sram_15bit_altsyncram	sram_15bit_altsyncram_component (
				.address_a (address_a),
				.address_b (address_b),
				.clock0 (clock),
				.data_a (data_a),
