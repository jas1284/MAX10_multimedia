...
# create_clock -period "25.0 MHz" -name VGA_Clk [get_ports VGA_Clk]


# SDRAM CLK
create_generated_clock -source [get_pins { u0|altpll_0|sd1|pll7|clk[2] }] \
...
set_false_path -from [get_ports SWITCH*] -to *
set_false_path -from [get_ports SW*] -to *
set_false_path -from [get_ports altera_reserved*] -to *
...
set_false_path -from * -to [get_ports altera_reserved*]
